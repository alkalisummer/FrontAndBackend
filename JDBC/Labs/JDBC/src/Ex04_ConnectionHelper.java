...
public class Ex04_ConnectionHelper {
	...
	public static void main(String[] args) throws SQLException {
		...
		//1 return : oracle.jdbc.driver.T4CConnection@39a054a5
		//2.return: oracle.jdbc.driver.T4CConnection@d041cf
		//result: getConncetion() 함수 호출시마다 새로운 객체 생성
		//하나의 APP 연결 객체 하나만 사용해도 되지않을까 
		// 한번 만들어서 재사용 .. ?
