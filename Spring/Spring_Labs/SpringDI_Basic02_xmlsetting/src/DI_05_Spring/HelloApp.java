...
//	 
	 ...
	 //Key Point 
	 //컨테이너가 구성되고 xml read 해서 객체 생성 조립 
	 // 필요하다면 컨테이너안에 있는 객체를 사용 
	 //getbean() return type Object >> down casting 사용
	 //주의: getbean() 호출할때마다 새로운 객체를 만들지 않는다. 동일 객체의 주소값이 나옴 
	 //컨테이너안에 있는 모든 객체의 타입은: default(singleton)
	  ...
	  System.out.println("before: mybean2 객체 : "+ mybean3);
