...
-----------------------------------------------------------------
 ...
 SP   : /JSPBoard/created.jsp
   ...
   1.웹 브라우저가 가지고 있는 경로(가상 경로)
     http://localhost:8080/WebJSP/Ex11_WebApp_RealPath.jsp 
   
   2.Ex11_WebApp_RealPath.jsp 파일의 실경로(물리적) 경로는 ? 
     /Users/kihoon/WebJSP/JSPLab/WebJSP/WebContent/Ex11_WebApp_RealPath.jsp
     
   3.웹(가상경로) -> 실경로(물리적 경로) 반환해 주는 객체 
     request
     application
...
contextpath:/Users/kihoon/WebJSP/JSPLab/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/WebJSP/WebJSP
realpath: /Users/kihoon/WebJSP/JSPLab/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/WebJSP/download/note.txt
...
<%
   ...
   out.print("request.getcontextPath():" +application.getContextPath()+"<br>");
